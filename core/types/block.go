...
// and receipts.
func NewBlock( header *Header, txs []*Transaction, uncles []*Header, receipts []*Receipt, db ethdb.Database) *Block {
...
func (b *Block) PreMstHash() common.Hash   { return b.header.PreMstHash }
func (b *Block) MstHash() common.Hash   { return b.header.MstHash }
